...
| 能力 | 说明 |
| --- | --- |
| 本地透明代理 | 暴露 OpenAI、Anthropic、Codex、Pi、TokenRouter、AnyRouter、Zo Computer 等本地入口，自动注入上游鉴权。 |
...
flowchart LR
  ...
  subgraph Providers["上游服务"]
    ...
    Kimi["Kimi"]
    Mimo["Xiaomi MiMo"]
    More["Zhipu / MiniMax / Gemini / OpenRouter / TokenRouter / sub2api / new-api / AnyRouter / Zo / Custom"]
  end
