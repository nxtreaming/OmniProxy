        ...
        <div class="endpoint-reference">
          <div class="endpoint-reference-note">
            ...
            <p>
              ...
              <code>http://127.0.0.1:{{ proxyPort }}/prem/v1</code>；Prem Anthropic 填
              <code>http://127.0.0.1:{{ proxyPort }}/prem/anthropic/v1</code>；Forge 填
              <code>http://127.0.0.1:{{ proxyPort }}/forge/v1</code>；Forge Anthropic 填
              <code>http://127.0.0.1:{{ proxyPort }}/forge/anthropic/v1</code>；API Key 填 <code>omniproxy-local</code>。
            </p>
          </div>
