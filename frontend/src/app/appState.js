...
export function createAppState() {
  ...
  const state = {
    ...
    exportingDiagnostics: ref(false),
    exportingConfig: ref(false),
    importingConfig: ref(false),
    configSnapshotBusy: ref(''),
    ...
    config: reactive({
      ...
      outboundProxyProviders: ['openai', 'anthropic', 'gemini', 'openrouter', 'forge', 'zo', 'prem'],
