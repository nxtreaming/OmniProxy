      ...
      endpoints: [
        {
          ...
          models: '使用网关路由里的 OpenAI 兼容默认模型，例如 gpt-5.4',
          use: '通用 OpenAI 兼容入口；后端厂商、凭据和默认模型在「网关路由」页面选择。',
        },
        {
          name: 'Codex Router',
          ...
          apiKey: 'omniproxy-local',
          models: '使用网关路由里的 Codex 默认模型，例如 gpt-5.4',
          use: 'Codex 和 OpenAI 兼容客户端可固定接入这里；后端厂商由网关路由选择。',
        },
        {
          name: 'Zo Computer',
          protocol: 'OpenAI Chat / Responses',
      ...
      endpoints: [
        {
          ...
          baseUrl: `${base}/codex/v1`,
          apiKey: 'omniproxy-local',
          models: '使用网关路由里的 Codex 默认模型',
          use: 'Codex CLI 一键配置会写入这个稳定入口；切换后端不需要重写 Codex 配置。',
        },
        {
          ...
          apiKey: 'omniproxy-local',
          models: '使用网关路由里的 OpenAI 兼容默认模型，或客户端发送的模型名',
          use: 'OpenCode 一键配置只添加 omniproxy provider；后端厂商在网关路由中选择。',
        },
        {
          name: 'Pi Router',
          protocol: 'OpenAI Chat',
          ...
          apiKey: 'omniproxy-local',
          models: '使用网关路由里的 OpenAI 兼容默认模型，或客户端发送的模型名',
          use: 'Pi Coding Agent 一键配置只添加 omniproxy provider；后端厂商在网关路由中选择。',
        },
        {
